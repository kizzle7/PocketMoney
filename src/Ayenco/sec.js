...
Questions related to the form can be sent via email to customercare@uvlot.com or via WhatsApp to 09073333484 or 08062750890</p>
                    ...
                    <form className="">
                        ...
                        <div className="form-group">
                        <label>POCKET MONI ACCOUNT NUMBER</label>
                            <input type="text" name="pocm" className="form-control" onChange ={this.onChange} />
                        </div>
                        <div className="form-group">
                        ...
                        <Link to={{pathname: `/pocket_form2`, state: this.state}}><button className="btn btn- btn-info">Next</button></Link>
                        </div>    
